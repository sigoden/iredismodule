...
use redismodule::{
    Context, Error, ListPosition, RResult, RStr, Value, KeyType, ArgvFlags,
...
#[rcmd(name="hello.push.native",flags="write deny-oom",first_key=1,last_key=1,key_step=1)]
...
#[rcmd(name="hello.push.call",flags="write deny-oom",first_key=1,last_key=1,key_step=1)]
...
#[rcmd(name="hello.push.call2",flags="write deny-oom",first_key=1,last_key=1,key_step=1)]
fn hello_push_call2(ctx: &mut Context,args: Vec<RStr>) -> RResult {
    hello_push_call(ctx, args)
}

#[rcmd(name="hello.push.sum.len",flags="readonly",first_key=1,last_key=1,key_step=1)]
...
#[rcmd(name="hello.list.splice",flags="write deny-oom",first_key=1,last_key=2,key_step=1)]
...
#[rcmd(name="hello.list.splice.auto",flags="write deny-oom",first_key=1,last_key=2,key_step=1)]
fn hello_list_splice_auto(ctx: &mut Context,args: Vec<RStr>) -> RResult {
    hello_list_splice(ctx, args)
}

#[rcmd(name="hello.rand.array",flags="readonly",first_key=0,last_key=0,key_step=0)]
fn hello_rand_array(ctx: &mut Context,args: Vec<RStr>) -> RResult {
    assert_len!(args, 2);
...
#[rcmd(name="hello.repl2",flags="write",first_key=1,last_key=1,key_step=1)]
...
#[rcmd(name="hello.toggle.case",flags="write",first_key=1,last_key=1,key_step=1)]
...
#[rcmd(name="hello.more.expire",flags="write",first_key=1,last_key=1,key_step=1)]
...
#[rcmd(name="hello.zsumrange",flags="readonly",first_key=1,last_key=1,key_step=1)]
...
#[rcmd(name="hello.lexrange",flags="readonly",first_key=1,last_key=1,key_step=1)]
...
#[rcmd(name="hello.hcopy",flags="write deny-oom",first_key=1,last_key=1,key_step=1)]
...
#[rcmd(name="hello.leftpad",flags="",first_key=0,last_key=0,key_step=0)]
fn hello_leftpad(ctx: &mut Context,args: Vec<RStr>) -> RResult {
    assert_len!(args, 4);
